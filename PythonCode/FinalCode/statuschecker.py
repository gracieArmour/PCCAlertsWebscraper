def status_check(para):
    ...
    alert = {'It is now safe to resume normal activities':'green','open and observing normal operating hours':'green','restored':'green','outage':'yellow','emergency':'red','emergencies':'red','seek shelter':'red','evacuation':'red','evacuate':'red','evacuated':'red','evacuating':'red','drill':'orange','closed':'orange','close':'orange','closing':'orange','closure':'orange','cancel':'orange','cancelled':'orange'}
    for i in alert:
        if i in paragraph:
